...
2. Initialize your local repository using the LineageOS trees with a command
  repo init -u git://github.com/LineageOS/android.git -b lineage-16.0-aospway
  
3. Clone this repo:
  git clone https://github.com/team-infusion-developers/android_local_manifests_i9300 .repo/local_manifests -b lineage-16.0
